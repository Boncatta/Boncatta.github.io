(() => {
  ...
  const EFFECTS = {
    ...
    empty_needle: "对指定敌方施加空针；该目标下次受到治疗时，治疗无效并转化为同等伤害。",
    medicine_crit_heal: "对指定敌方造成 10 点嗜血伤害，再治疗自身 10 点生命。",
    medicine_crit_silence: "一次索敌：对指定敌方造成 10 点伤害，并令同一目标行动点减少 1。",
    medicine_boost_heal: "自身下一次治疗倍率变为 2 倍，不叠加。",
    ...
    half_hp_and_attack: "令全场生命减半，不再追加普通攻击。",
    double_next_attack: "自身下一次攻击伤害翻倍，不叠加；双重打击和毁灭三连的所有段数都会受益。",
    ...
    attack_critical_draw: "连续发动两次普通攻击，两段可分别索敌，然后获得 1 个额外行动点。",
