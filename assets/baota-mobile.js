(() => {
  ...
  const SKILL_GUIDES = {
    ...
    empty_needle: ["空针", "指定一名敌人：其下次被治疗时，治疗转化为同等伤害。", "enemy", 1],
    medicine_crit_heal: ["嗜血之疗", "对一名敌人造成10点伤害，并治疗自己。", "enemy", 1],
    medicine_crit_silence: ["沉默重击", "对一名敌人造成10点伤害，并使其行动点-1。", "enemy", 1],
    medicine_boost_heal: ["治疗整备", "强化自己的下一次治疗效果，不叠加。", "self", 0],
    ...
    half_hp_and_attack: ["裂空一击", "全场生命削减，不再追加攻击。", "any", 0],
    double_next_attack: ["力量凝聚", "自己的下次攻击威力翻倍，不叠加。", "self", 0],
    ...
    attack_critical_draw: ["暴力连打", "连续选择2次普通攻击目标，然后获得额外行动。", "enemy", 2],
